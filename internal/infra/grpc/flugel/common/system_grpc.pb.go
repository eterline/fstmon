...
const (
	SystemService_GetSystemInfo_FullMethodName = "/fstmon.system.SystemService/GetSystemInfo"
)
...
func (c *systemServiceClient) GetSystemInfo(ctx context.Context, in *GetSystemInfoRequest, opts ...grpc.CallOption) (*SystemInfoResponse, error) {
...
func (UnimplementedSystemServiceServer) GetSystemInfo(context.Context, *GetSystemInfoRequest) (*SystemInfoResponse, error) {
...
var SystemService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "fstmon.system.SystemService",
