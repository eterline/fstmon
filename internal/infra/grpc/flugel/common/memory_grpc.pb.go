...
const (
	MemoryService_GetMemoryMetrics_FullMethodName = "/fstmon.memory.MemoryService/GetMemoryMetrics"
)
...
func (c *memoryServiceClient) GetMemoryMetrics(ctx context.Context, in *GetMemoryMetricsRequest, opts ...grpc.CallOption) (*MemoryMetricsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MemoryMetricsResponse)
	err := c.cc.Invoke(ctx, MemoryService_GetMemoryMetrics_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMemoryServiceServer) GetMemoryMetrics(context.Context, *GetMemoryMetricsRequest) (*MemoryMetricsResponse, error) {
...
func _MemoryService_GetMemoryMetrics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetMemoryMetricsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MemoryServiceServer).GetMemoryMetrics(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MemoryService_GetMemoryMetrics_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MemoryServiceServer).GetMemoryMetrics(ctx, req.(*GetMemoryMetricsRequest))
	}
...
var MemoryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "fstmon.memory.MemoryService",
	HandlerType: (*MemoryServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetMemoryMetrics",
			Handler:    _MemoryService_GetMemoryMetrics_Handler,
		},
	},
